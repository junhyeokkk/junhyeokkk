...
Node.js / TypeScript 기반 백엔드 개발자입니다.  
데이터 정합성 검증, 운영 자동화, 대용량 데이터 처리,  
Azure 환경 서비스 운영 경험을 중심으로 개발하고 있습니다.

Express → NestJS 마이그레이션,  
Blob Storage · Cosmos DB 기반 검증 시스템,  
Jenkins CI/CD 파이프라인 구축 경험이 있습니다.
...
| **[Farmstory](https://github.com/junhyeokkk/Farmstory_TEAM1)** | 농산물 직거래 플랫폼 | `Java` `JSP` |
...
- 선박 데이터 관리 Backoffice 시스템 구축
- Express → NestJS 아키텍처 마이그레이션
- Jenkins 기반 Azure CI/CD 파이프라인 구축
- 운영 데이터 정합성 검증 자동화 시스템 구현
---
